...
! function() {
    ...
    function jt(t) {
        ...
        var w, x, k, A, C, O, S, P, N, M, z, E, j, L, R, I, _, T, Y, F, H, D, U, W, q, X, B, V = Q({}, y, {
                prefix: r,
                iconName: i,
                main: n,
                mask: a,
    ...
    function Jt(t) {
        return t.reduce(function(t, e) {
            ...
            if (Kt[e]) t.prefix = e;
            else if ($.autoFetchSvg && -1 < ["fas", "far", "fal", "fad", "fab", "fa"].indexOf(e)) t.prefix = e;
            else if (n) {
    ...
    var ee = {
        replace: function(t) {
            ...
            if (e.parentNode && e.outerHTML) e.outerHTML = n + ($.keepOriginalSource && "svg" !== e.tagName.toLowerCase() ? "\x3c!-- ".concat(e.outerHTML, " --\x3e") : "");
        ...
        if (l && $.observeMutations) {
            ...
            oe = new l(function(t) {
                re || At(t).forEach(function(t) {
                    if ("childList" === t.type && 0 < t.addedNodes.length && !te(t.addedNodes[0]) && ($.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && $.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && te(t.target) && ~T.indexOf(t.attributeName))
